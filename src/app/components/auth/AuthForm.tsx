...
export function AuthForm() {
    ...
    const orangeInputSx = {
        ...
        '& .MuiInputLabel-root.Mui-focused': { color: '#f97316 !important' }
    }

    const orangeOutlinedSx = {
        textTransform: 'none',
        borderColor: 'rgba(249, 115, 22, 0.5) !important',
        color: '#f97316 !important',
        '&:hover': {
            borderColor: '#f97316 !important',
            bgcolor: 'rgba(249, 115, 22, 0.05) !important'
        }
    }
                ...
                <Stack spacing={2}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 0.5 }}>
                                    <Button
                                        ...
                                        sx={{
                                            ...
                                            minWidth: 'auto',
                                            padding: '4px 8px',
                                            '&:hover': { bgcolor: 'rgba(249, 115, 22, 0.05) !important' }
                                        }}
                                    >
                                        Forgot password?
                                    </Button>
                    ...
                    <Button
                        ...
                        sx={{
                            ...
                            fontWeight: 'bold',
                            '&:hover': {
                                boxShadow: '0 8px 25px rgba(249, 115, 22, 0.4) !important',
